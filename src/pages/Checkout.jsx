                ...
                <div className="checkout-success">
                    <div className="checkout-success-icon">
                        <svg viewBox="0 0 52 52" fill="none" aria-hidden="true">
                            ...
                            <path d="M14 27l9 9 15-18" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                    ...
                    {fulfillment === "pickup" && (
                        <p className="checkout-success-ref">
                            {locations[pickupLocation].name} — {locations[pickupLocation].addressLines.join(" ")}
                        </p>
                    )}
                    <p className="checkout-success-ref">
                    ...
                    <div className="checkout-success-summary">
                        {cart.map((item) => (
                            <div key={item.name} className="checkout-success-item">
        ...
        <main className="checkout-page">
            ...
            <div className="checkout-layout">
                ...
                <aside className="checkout-summary">
                    <h2 className="checkout-section-title">{c.orderSummary}</h2>
                    <ul className="checkout-summary-list">
                        {cart.map((item) => (
                            <li key={item.name} className="checkout-summary-item">
                ...
                <form className="checkout-form" onSubmit={handleConfirm}>
                    ...
                    <section className="checkout-section">
                        <h2 className="checkout-section-title">{c.fulfillmentTitle}</h2>
                        <div className="checkout-radio-group">
                            <label className={`checkout-radio-option${fulfillment === "pickup" ? " selected" : ""}`}>
                                <input
                                    type="radio"
                                    name="fulfillment"
                                    value="pickup"
                            ...
                            <label className={`checkout-radio-option${fulfillment === "delivery" ? " selected" : ""}`}>
                                <input
                                    type="radio"
                                    name="fulfillment"
                                    value="delivery"
                        ...
                        {fulfillment === "pickup" && (
                            <div className="checkout-location-picker">
                                <p className="checkout-location-label">{c.pickupLocationTitle}</p>
                                    ...
                                    {locations.map((loc, i) => (
                                        ...
                                        >
                                            <input
                                                ...
                                                name="pickupLocation"
                                                value={i}
                                                checked={pickupLocation === i}
                                                onChange={() => setPickupLocation(i)}
                                            />
                    ...
                    {/* Contact */}
                    <section className="checkout-section">
                        <h2 className="checkout-section-title">{c.contactTitle}</h2>
                    ...
                    {/* Payment */}
                    <section className="checkout-section">
                        <h2 className="checkout-section-title">{c.paymentTitle}</h2>
                        <div className="checkout-mock-notice">{c.mockNotice}</div>
                        <div className="checkout-field">
                            <input
                                type="text"
