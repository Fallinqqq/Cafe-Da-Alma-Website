...
const shopCategoriesByLocale = {
  ...
  pt: [
    ...
    },
    {
      ...
      navLabel: 'Merch',
      route: '/shop/merchandise',
      description: 'Produtos da Cafe Da Alma para presente, preparo e uso diario.',
      products: [
    ...
    },
    {
      ...
      products: [
        ...
        { name: 'Single Origin 12oz', price: '$20.00' },
        { name: 'Decaf Roast 12oz', price: '$18.00' },
        { name: 'Cha Berry Hibiscus', price: '$13.00' },
        { name: 'Blend de Mate', price: '$14.00' },
        { name: 'Blend de Cha Preto', price: '$15.00' },
      ],
    },
  ],
};
