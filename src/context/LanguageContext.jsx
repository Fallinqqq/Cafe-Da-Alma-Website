...
const translations = {
    en: {
        ...
        checkout: {
            ...
            address2Placeholder: "Apt, suite, floor (optional)",
    ...
    pt: {
        ...
        checkout: {
            ...
            addressPlaceholder: "Logradouro",
            address2Placeholder: "Apto, bloco, andar (opcional)",
            cityPlaceholder: "Cidade",
            zipPlaceholder: "CEP / ZIP",
            delivery: "Entrega",
            ...
            mockNotice:
                "Apenas demonstracao — nenhum pagamento real e processado.",
